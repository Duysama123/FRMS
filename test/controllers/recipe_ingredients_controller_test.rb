...
class RecipeIngredientsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recipe_ingredient" do
    assert_difference("RecipeIngredient.count") do
      post recipe_ingredients_url, params: { recipe_ingredient: { ingredient_id: @recipe_ingredient.ingredient_id, optional: @recipe_ingredient.optional, quantity: @recipe_ingredient.quantity, recipe_id: @recipe_ingredient.recipe_id, unit: @recipe_ingredient.unit } }
    end
  ...
  test "should update recipe_ingredient" do
    patch recipe_ingredient_url(@recipe_ingredient), params: { recipe_ingredient: { ingredient_id: @recipe_ingredient.ingredient_id, optional: @recipe_ingredient.optional, quantity: @recipe_ingredient.quantity, recipe_id: @recipe_ingredient.recipe_id, unit: @recipe_ingredient.unit } }
